Shader "FlatKit/Stylized Surface"
{
    Properties
    {
        ...
        _GradientFill("[DR_GRADIENT_ON]Fill Top -> Down", Range(0, 1)) = 1
        _GradientSoftness("[DR_GRADIENT_ON]Fill Softness", Range(0.001, 0.5)) = 0.1
        _GradientInvert("[DR_GRADIENT_ON]Invert", Range(0, 1)) = 0
