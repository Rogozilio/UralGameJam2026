...
CBUFFER_END
    ...
    UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
        ...
        UNITY_DOTS_INSTANCED_PROP(float , _GradientFill)
        UNITY_DOTS_INSTANCED_PROP(float , _GradientSoftness)
        UNITY_DOTS_INSTANCED_PROP(float , _GradientInvert)
    ...
    #define _GradientFill       UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _GradientFill)
    #define _GradientSoftness   UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _GradientSoftness)
    #define _GradientInvert     UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _GradientInvert)
...
inline void InitializeSimpleLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    ...
    outSurfaceData.alpha = albedo.a * _BaseColor.a * _Opacity;
