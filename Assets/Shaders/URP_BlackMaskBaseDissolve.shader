Shader "Custom/URP/BlackMaskBaseDissolve"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        half3 EvalToonLight(half3 albedo, half3 normalWS, Light lightData)
        {
        ...
        Pass
        {
            Name "ForwardBlackMaskBaseDissolve"
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half3 lit = EvalToonLight(blackenedAlbedo, nWS, mainLight);
                    ...
                    LIGHT_LOOP_BEGIN(count)
                        ...
                        #endif
                        lit += EvalToonLight(blackenedAlbedo, nWS, add);
                    LIGHT_LOOP_END
                #endif

                // Keep the base map readable even when preview/scene lighting is absent.
                lit += blackenedAlbedo * max(half3(0.15h, 0.15h, 0.15h), SampleSH(nWS));
